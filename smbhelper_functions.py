...
class SmbHelper(QMainWindow, Ui_SMBWindow):
    ...
    def apply_clicked(self):
        ...
        if self.get_uid_gid():
            ...
            self.samba_config.msg_overwrite_credentials_file(self)
    ...
    def get_uid_gid(self):
        try:
            ...
            self.fstab_entry = f"//{self.samba_ip}/{self.samba_share} {self.samba_path} cifs rw,x-systemd.automount,credentials={self.samba_path_credentials},sfd={self.uid},gid={self.gid} 0 0"
            return True
